...
public partial class Admin_customerLoginRecord : System.Web.UI.Page
{
    ...
    protected void BindGrid()
    {
        ...
        SqlDataSource1.SelectCommand = "SELECT * FROM tb_login";
        GridView1.DataBind();
    }
    protected void txtsearch_TextChanged(object sender, EventArgs e)
    {
        ...
        if (!string.IsNullOrEmpty(searchText))
        {
            ...
            SqlDataSource1.SelectCommand = "SELECT * FROM tb_login WHERE user LIKE '%' + @searchText + '%' OR email LIKE '%' + @searchText + '%' OR mobile LIKE '%' + @searchText + '%'";
